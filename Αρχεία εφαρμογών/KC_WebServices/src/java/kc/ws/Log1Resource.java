...
public class Log1Resource {
    ...
    /**
     * Retrieves representation of an instance of kc.ws.Log1Resource
    ...
    public String getJson() throws ClassNotFoundException, SQLException {
        ...
        String sql = "SELECT exams.exam_id, exam_datetime, exam_center_name, exam_center_addr, username, result FROM exams, exam_centers, users, results, exam_matches WHERE users.user_id = exam_matches.user_id AND results.match_id = exam_matches.match_id AND exams.exam_id = exam_matches.exam_id AND exam_centers.exam_center_id = exams.exam_center_id";
