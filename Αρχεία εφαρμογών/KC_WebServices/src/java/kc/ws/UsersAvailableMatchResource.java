 ...
 */
@Path("users_available_match")
public class UsersAvailableMatchResource {
     ...
     */
    public UsersAvailableMatchResource() {
    }

    /**
     * Retrieves representation of an instance of kc.ws.UsersAvailableMatchResource
    ...
    public String users_available_match() throws ClassNotFoundException, SQLException {
        ...
        String sql = "SELECT user_id, username, password, full_name FROM users WHERE user_id NOT IN (SELECT user_id FROM exam_matches) AND role_id = 3";
