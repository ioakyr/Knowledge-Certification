 ...
 */
public class AddCenter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Όνομα κέντρου:");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Διεύθυνση κέντρου:");
        ...
        jLabel4.setText("Εισαγωγή κέντρου");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String center_name = jTextField1.getText();
        String center_addr = jTextField2.getText();
        jLabel3.setText(add_center(center_name, center_addr));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCenter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
